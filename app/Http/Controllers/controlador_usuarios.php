...
class controlador_usuarios extends Controller {
    ...
    public function listarUsuarios() {
        $usuarios = DB::table('usuarios')
                ->select('id_user' ,'nombre', 'apellidos', 'email', 'password', 'rol', 'localidad', 'latitud', 'longitud', 'pais', 'img_user')
                ->paginate(8);
    ...
    public function eliminarusuarios() {
        $id_user = intval($_POST["identificador"]);
        $qhp = "ok";

        $publicacion = DB::table('usuarios')
